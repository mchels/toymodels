...
const file_proto_raft_proto_rawDesc = "" +
	"\n" +
	"\x10proto/raft.proto\x12\akvstore\"\x95\x01\n" +
	...
	"\acommand\x18\x03 \x01(\fR\acommand2\xa0\x01\n" +
	"\x04Raft\x12H\n" +
	"\vRequestVote\x12\x1b.kvstore.RequestVoteRequest\x1a\x1c.kvstore.RequestVoteResponse\x12N\n" +
	"\rAppendEntries\x12\x1d.kvstore.AppendEntriesRequest\x1a\x1e.kvstore.AppendEntriesResponseB\tZ\a./protob\x06proto3"
...
var file_proto_raft_proto_goTypes = []any{
	...
	(*AppendEntriesRequest)(nil),  // 2: kvstore.AppendEntriesRequest
	(*AppendEntriesResponse)(nil), // 3: kvstore.AppendEntriesResponse
	(*LogEntry)(nil),              // 4: kvstore.LogEntry
}
var file_proto_raft_proto_depIdxs = []int32{
	4, // 0: kvstore.AppendEntriesRequest.entries:type_name -> kvstore.LogEntry
	0, // 1: kvstore.Raft.RequestVote:input_type -> kvstore.RequestVoteRequest
	2, // 2: kvstore.Raft.AppendEntries:input_type -> kvstore.AppendEntriesRequest
	1, // 3: kvstore.Raft.RequestVote:output_type -> kvstore.RequestVoteResponse
	3, // 4: kvstore.Raft.AppendEntries:output_type -> kvstore.AppendEntriesResponse
